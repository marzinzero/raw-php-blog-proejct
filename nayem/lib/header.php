...
<nav class="navbar navbar-expand-md navbar-dark bg-info">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="user.php"><i class="fas fa-user"></i>Author Profile</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="changepass.php"><i class="fas fa-exchange-alt"></i>Change Password</a>
      </li>
      <li class="nav-item">
        <a class="nav-link disabled" href="adduser.php"><i class="fas fa-user-edit"></i>Add User</a>
      </li>
       <li class="nav-item">
         <a class="nav-link disabled" href="msg.php"><i class="far fa-envelope"></i>Inbox</a>
      </li>
    </ul>
  </div>
</div>
